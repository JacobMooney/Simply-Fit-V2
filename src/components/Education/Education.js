    ...
    <body>
      ...
      <div className="container infoArea">
        ...
        <p>
          ...
          to workout can come from many sources but often time can be difficult
          to muster if you base it on slow changing things like physical
          changes.
        </p>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                The amount of repetitions preformed per set. | Example; 1 single
                push up is 1 rep or repetition.
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                ...
                Example; 5 push ups in sequence, followed by a break, and then 5
                more push ups would be 2 sets of 5 reps.
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                Commonly how reps and sets are written in routines. | Example; 3
                x 10 would mean 10 repetitions for each of the 3 sets.
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                Exercises that work multiple muscle groups at once. Bench Press,
                Deadlift, Squat, Pull Ups, Over Head Press, etc.
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                Exercises that mainly target one specific muscle group. Dumbbell
                Curl, Dumbbell or Machine Chest Fly, etc.
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                The effect of an exercises ability to increase muscle size.
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <p>
          ...
          training and then change routines when the gains start to diminish.
        </p>
        ...
        <ul>
          ...
          <p>
            ...
            benifit of machines, is they allow you to push yourself closer to
        ...
        <p>
          Here is a link to an <a href="http://www.fitnotesapp.com/">Android</a>{" "}
          and <a href="https://www.getfitnotes.com/">IOS</a> version of the same
          app that is great for tracking your gym progress. Using these in
          combination with the routine builder, you will be able to start
          working out on the right foot.
        </p>
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              emphasis here is on training volume and taking the majority of
              sets to the 10-12 rep range while preforming more exercises total.
              Due to the volume of this type of routine, most of the work should
              be done in the 65% to 80% 1 rep max range.
            </p>
          </li>
          ...
          <li>
            ...
            <p>
              ...
              set smaller in the beginning of the routine. While strength
              routines are about getting stronger faster, they also tend to
              benifit from less is more. So the first 2 lifts of each day should
              be the hardest part of the session in the 85% to 95% 1 rep max
              range. The remaining exercises for each day will help condition
              and provide some support for overall strength.
            </p>
          </li>
          ...
          <li>
            ...
            <p>
              ...
              training goals. The key point here is partially copying the
              strength routines hard first 2 lifts, but adding more total
              lifts/volume to the workout like the bodybuilding routine.
            </p>
          </li>
        </ul>
      </div>
